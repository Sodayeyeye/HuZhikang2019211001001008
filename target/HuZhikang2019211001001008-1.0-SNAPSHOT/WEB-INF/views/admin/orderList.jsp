			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
						...
						<tr>
							...
							<td>${o.orderDate}</td>
							<%
								com.HuZhiKang.model.Order o=(com.HuZhiKang.model.Order)pageContext.findAttribute("o");
								int userId=o.getCustomerId();
								java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
								com.HuZhiKang.dao.UserDao userDao=new com.HuZhiKang.dao.UserDao();
							...
							<td class="cart_total">
								<%
									...
									String paymentType=com.HuZhiKang.model.Payment.findByPaymentId(con,n);
								%>
